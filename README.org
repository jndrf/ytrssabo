...
To install, simply do
  ...
  poetry install
  #+END_SRC
At some point, a package will be available.
...
This will install the [[https://docs.astral.sh/ruff/][ruff]] python linter and formatter and sets git hooks to run both on every commit.
